...
export default function ContactComponent(){
    return(
        ...
        <div className="row">
            ...
            <div>
                <p>“Our Mission is to make information technology an asset for every business, to grow a market leader by consistently surpassing our customer's expectations; equipping them with the best of breed technology solutions, to enhance our products and services, and to learn from our customers. Our mission is to make web & mobile technology solutions affordable for everyone.”</p>
            </div>
            </div>
